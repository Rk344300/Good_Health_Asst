  ...
  return (
    <div className='wellness'>
           <div className='overview'>
             ...
             <div className='overweight'><span style={{fontSize :"30px"}}><b>40</b></span>
             &nbsp;&nbsp; <span className='overwg'>overweight</span></div>
           ...
           <div className='wellnessDetails'>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                    ...
                    <span style={{fontSize:"14px"}}><b>80.5 Kgs</b></span>
                </div>

                <div className='details'>
                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
                <mask id="mask0_0_224" style={{maskType:"alpha"}} maskUnits="userSpaceOnUse" x="1" y="3" width="16" height="11">
                    <path d="M15.8613 9.89105H2M2 4V12.3168V4ZM15.8613 9.89105V12.3168V9.89105Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M8.23767 5.38623V9.89115H15.8614V6.42583C15.8614 6.15011 15.7519 5.88568 15.5569 5.69072C15.3619 5.49576 15.0975 5.38623 14.8218 5.38623H8.23767Z" fill="white" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M5.11855 7.8121C5.69271 7.8121 6.15815 7.34666 6.15815 6.77251C6.15815 6.19835 5.69271 5.73291 5.11855 5.73291C4.5444 5.73291 4.07896 6.19835 4.07896 6.77251C4.07896 7.34666 4.5444 7.8121 5.11855 7.8121Z" fill="white" stroke="white" stroke-width="2"/>
                </mask>
                <g mask="url(#mask0_0_224)">
                    <path d="M0 0H17V17H0V0Z" fill="#F23CB4"/>
                </g>
                </svg>
                <span style={{fontSize:"14px"}}><b>7/8 Hours</b></span>
                </div>
                ...
                <path d="M9.00021 1.50012C5.00271 4.91262 3.00021 7.86012 3.00021 10.3501C3.00021 14.0851 5.85021 16.5001 9.00021 16.5001C12.1502 16.5001 15.0002 14.0851 15.0002 10.3501C15.0002 7.86012 12.9977 4.91262 9.00021 1.50012ZM5.87271 10.5001C6.15021 10.5001 6.37521 10.6951 6.42771 10.9651C6.73521 12.6301 8.13771 13.2001 9.15771 13.1176C9.48021 13.1026 9.75021 13.3576 9.75021 13.6801C9.75021 13.9801 9.51021 14.2276 9.21021 14.2426C7.61271 14.3401 5.74521 13.4251 5.31771 11.1526C5.30468 11.0722 5.30926 10.9899 5.33115 10.9115C5.35304 10.833 5.39172 10.7602 5.44449 10.6982C5.49727 10.6361 5.5629 10.5863 5.63683 10.5521C5.71077 10.5179 5.79125 10.5002 5.87271 10.5001Z" fill="#2F72F0"/>
                    ...
                    <span style={{fontSize:"14px"}}><b>4/8 Glasses</b></span>
                </div>
